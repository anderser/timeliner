(function(){
  ...
  Intervals.dateStr = function(timestamp, interval) {
    ...
    var dDate             =   d.getDate() + ". " + dMonth + ', ' + dYear;
    //var bigHours          = d.getHours() > 12;
    //var isPM              = d.getHours() >= 12;
    var dHourWithMinutes  = d.getHours() + ":" + d.getMinutes(); //(bigHours ? d.getHours() - 12 : (d.getHours() > 0 ? d.getHours() : "12")) + ":" + padNumber(d.getMinutes()) + " " + (isPM ? 'p.m.' : 'a.m.');
